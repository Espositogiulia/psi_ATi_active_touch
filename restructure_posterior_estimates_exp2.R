...
d<-list(mu_a=fit_classical_exp2$draws(variables="mu_a",format="draws_matrix"),
        mu_b=fit_classical_exp2$draws(variables="mu_log10_b",format="draws_matrix"),
        mu_logit_l=fit_classical_exp2$draws(variables="mu_logit_l",format="draws_matrix"),
        a=fit_classical_exp2$draws(variables="a",format="draws_matrix"),
        b=fit_classical_exp2$draws(variables="b",format="draws_matrix"),
        l=fit_classical_exp2$draws(variables="l",format="draws_matrix"),
        sigma_a=fit_classical_exp2$draws(variables="sigma_a",format="draws_matrix"),
        sigma_b=fit_classical_exp2$draws(variables="sigma_log10_b",format="draws_matrix"),
        sigma_logit_l=fit_classical_exp2$draws(variables="sigma_logit_l",format="draws_matrix")
)
...
#print(f1120)
ggsave(filename = "IndividualFits2_210211.tiff",plot=f1120,device = "tiff",dpi=300,units="cm",width=15,height =10)
...
temperature<-seq(-3.5,3.5,0.02)
visualizeFullModelPosterior(d,temperature,10^3)
ggsave(filename = "PsiATiPost_new2510.tiff",device = "tiff",dpi=300,units="cm",width=20,height = 10)
#ggsave(filename = "PsiATiPost_new2510.png",device = "png",dpi=600,units="cm",width=20,height = 10)
